...
QT_MOC_LITERAL(1, 14, 18), // "restartApplication"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 16), // "isProcessRunning"
QT_MOC_LITERAL(4, 51, 11), // "processName"
QT_MOC_LITERAL(5, 63, 21), // "forceTerminateProcess"
QT_MOC_LITERAL(6, 85, 26) // "forceTerminateAllProcesses"

    },
    "ProcessHelper\0restartApplication\0\0"
    "isProcessRunning\0processName\0"
    "forceTerminateProcess\0forceTerminateAllProcesses"
};
...
void ProcessHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->isProcessRunning((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { bool _r = _t->forceTerminateProcess((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: { bool _r = _t->forceTerminateAllProcesses((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
