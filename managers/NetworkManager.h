...
private slots:
    ...
    // 翻译处理
    void onTranslationFinished(quint64 msgId, quint32 pid, quint32 flag, quint32 extraScope, quint32 direction, QString originalMessage, QString translatedMessage, QString language);
private:
    // Socket相关
