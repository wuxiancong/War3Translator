...
public:
    ...
    Q_INVOKABLE void requestTranslationWithMetadata(quint32 pid, quint32 flag, quint32 extraScope, QString message, QString language);
...
signals:
    ...
    void translationTaskFinished(quint32 pid, quint32 flag, quint32 extraScope, QString originalMessage, QString translatedMessage);
